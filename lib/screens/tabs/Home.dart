...
class _HomePageState extends State<HomePage> {
  ...
  TextEditingController _shareTextController = TextEditingController(); // Controller to capture text from TextField
    ...
    try {
      ...
      if (user != null) {
        ...
        setState(() {
          ...
          _userProfilePic = userDoc['profile']; // Assuming 'profilePic' field exists
          _isLoading = false;
        });
      }
    } catch (e) {
                                                      ...
                                                      onTap: () async {
                                                        if (isLiked) {
                                                          await FirebaseFirestore.instance.collection('posts').doc(postDoc.id).update({
                                                            'likedBy': FieldValue.arrayRemove([_user?.uid])
                                                          });
                                                        } else {
                                                          await FirebaseFirestore.instance.collection('posts').doc(postDoc.id).update({
                                                            'likedBy': FieldValue.arrayUnion([_user?.uid])
                                                          });
                                                        }
                                                        setState(() {});
                                                      },
                                                            ...
                                                            children: [
                                                              ...
                                                              Column(
                                                                children: [
                                                                  ...
                                                                  TextField(
                                                                    controller: _shareTextController, // Attach the controller
                                                                    maxLength: 50,
                                                                    maxLines: 2,
                                                                    ...
                                                                    decoration: InputDecoration(
                                                                      ...
                                                                      hintStyle: TextStyle(fontSize: 15, color: Colors.grey.shade500, letterSpacing: 1.0),
                                                              ...
                                                              Padding(
                                                                ...
                                                                child: Container(
                                                                  ...
                                                                  padding: EdgeInsets.all(15.0), // Padding inside the border
                                                                  child: Column(
                                                                    crossAxisAlignment: CrossAxisAlignment.start,
                                                                    children: [
                                                                      Row(
                                                                      ...
                                                                      SizedBox(height: 10),
                                                                      Visibility(
                                                                        visible: postData['text'] != null && postData['text'].isNotEmpty,
                                                                        child: Padding(
                                                                ...
                                                                children: [
                                                                  ...
                                                                  ElevatedButton(
                                                                    onPressed: () async {
                                                                      ...
                                                                      await FirebaseFirestore.instance
                                                                        ...
                                                                        'postId': postDoc.id,
                                                                        'userId': _user?.uid,
                                                                        'sharedText': _shareTextController.text, // Save the entered text
                                                                  ...
                                                                  OutlinedButton(
                                                                    ...
                                                                    style: OutlinedButton.styleFrom(
                                                                      primary: Theme.of(context).colorScheme.secondary, // Text color
                                                                      side: BorderSide(
